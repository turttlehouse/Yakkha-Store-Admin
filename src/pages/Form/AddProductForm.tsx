...
const AddProductForm = () => {
    ...
    const handleChange = (e:ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>)=>{
      //files property is only available on input type file
      //but ts is giving an error because it cannot guarantee that e.target is an HTMLInputElement with a files property.
      //so we need to tell ts that e.target is an HTMLInputElement using type assertion
