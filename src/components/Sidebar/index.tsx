  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-1">
        <NavLink to="/">
          <div className='bg-white  mb-[-4rem] flex items-center text-black dark:bg-boxdark dark:text-white p-2 rounded-md'>
          <img src={Logo} alt="Logo" className='h-20 w-20'/>
          <div className="flex flex-col gap-1 justify-center items-center italic">
